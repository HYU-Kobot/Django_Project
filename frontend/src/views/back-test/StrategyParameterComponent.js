...
const StrategyParameterComponent = (strategy) => {
    ...
    const clicked = () => {
        axios
            .post('http://127.0.0.1:8000/parameter/', {
                period_buy: 'period_buy',
                standardDeviation_buy: 'standardDeviation_buy',
                period_sell: 'period_sell',
                standardDeviation_sell: 'standardDeviation_sell'
                ...
                <Grid xs={12} sm={12}>
                    ...
                    <SubCard title={'매수 기준'} secondary={'볼린저밴드 상단'} style={{ backgroundColor: 'rgba(0,200,83,0.2)' }}>
                        <Grid xs={12} sm={12} container>
                            ...
                            <Grid xs={7.5} sm={7.5}>
                                <TextField value={ period_buy } fullWidth margin={'normal'} />
                            </Grid>
                        </Grid>
                        ...
                        <Grid xs={12} sm={12} container>
                            ...
                            <Grid xs={7.5} sm={7.5}>
                                <TextField value={ standardDeviation_buy} fullWidth margin={'normal'} />
                            </Grid>
                        </Grid>
                    </SubCard>
                    ...
                    <SubCard title={'매도 기준'} secondary={'볼린저밴드 중단'} style={{ backgroundColor: 'rgba(216,67,21,0.2)' }}>
                        <Grid xs={12} sm={12} container>
                            ...
                            <Grid xs={7.5} sm={7.5}>
                                <TextField value={ setperiod_sell } fullWidth margin={'normal'} />
                            </Grid>
                        </Grid>
                        ...
                        <Grid xs={12} sm={12} container>
                            ...
                            <Grid xs={7.5} sm={7.5}>
                                <TextField value={ setstandardDeviation_sell } fullWidth margin={'normal'} />
                            </Grid>
                        </Grid>
                    </SubCard>
                    ...
                    <Grid xs={12} sm={12}>
                        <Button
                            ...
                            fullWidth
                            variant={'contained'}
                            style={{ fontSize: '30px', backgroundColor: 'rgba(0,150,80,0.8)' }}
